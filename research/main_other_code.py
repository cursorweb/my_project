...
# --labels=$DATASET/labels.txt $DATASET/test/cat/01.jpg cat.jpg
...
parser.add_argument("--network", type=str, default=NETWORK, help="pre-trained model to load (see below for options)")
...
#
net = imageNet(model=NETWORK, labels="model/labels.txt", 
